...
PAIR_TABLE_PATH = Path(__file__).with_name("cv_valency_pairs.tsv")
...
def embedded_clause_span(parsed: ClauseMatch) -> EmbeddedSpan:
...
def perturb(
    ...
    expected_cv_stem = pair["cv_stem"].lower()
    tv_foil_stem = pair["tv_foil_stem"].lower()
