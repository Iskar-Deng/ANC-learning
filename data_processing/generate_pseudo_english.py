...
class PseudoEnglishGenerator:
    ...
    def __init__(self, similarity_threshold: float = 0.70) -> None:
        ...
        # each candidate:
        #   {"verb": str, "construction": "iv"|"tv"|"cv", "score": float, "stem": str, "suffix": str}
    ...
    def build_anc_lexicon(self) -> None:
        ...
        3. compare stem against verbs using bidirectional prefix threshold
    ...
    def _extract_anc_info_for_noun(
        ...
        if expected_construction in {"tv", "cv"}:
            # tv/cv:
            # poss/by -> subject -> ge
            # of      -> object  -> ob
